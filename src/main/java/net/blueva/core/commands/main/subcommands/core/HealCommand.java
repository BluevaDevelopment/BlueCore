...
public class HealCommand implements CommandInterface {
    ...
    @Override
    public void onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args) throws IOException {
