...
public class MidnightCommand implements CommandInterface {
    ...
    public void onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args) throws IOException {
        ...
        if (sender instanceof Player) {
            ...
            if (world == null) {
                MessagesUtils.sendToSender(sender, ConfigManager.language.getString("messages.other.use_noon_command"));
                return;
            }
            world.setTime(18000);
