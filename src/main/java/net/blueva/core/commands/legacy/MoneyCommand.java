...
public class MoneyCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args) {
        if (!(sender instanceof Player) && args.length != 1) {
            MessagesUtils.sendToSender(sender, ConfigManager.language.getString("messages.other.use_god_command"));
            return true;
        }
        ...
        if (args.length == 1) {
            ...
            MessagesUtils.sendToSender(target, ConfigManager.language.getString("messages.info.current_balance_others"));
        } else {
            ...
            MessagesUtils.sendToSender(target, ConfigManager.language.getString("messages.info.current_balance"));
        }
        return true;
    }
}